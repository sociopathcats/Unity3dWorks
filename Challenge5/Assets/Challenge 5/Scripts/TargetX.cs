...
public class TargetX : MonoBehaviour
{
    ...
    private void OnMouseDown()
    {
        ...
        {
            int goodObjectClicked = GameObject.FindGameObjectsWithTag("Good").Length;
            int badObjectClicked = GameObject.FindGameObjectsWithTag("Bad").Length;
            Debug.Log(badObjectClicked + goodObjectClicked);
            Destroy(gameObject);
